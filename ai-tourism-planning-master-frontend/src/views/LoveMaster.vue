...
import { chatWithTourismApp } from '../api'
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI旅游规划大师是ChenAI超级智能体应用平台的专业旅游顾问，帮你解答各种旅游规划问题，提供路线建议'
    },
    {
      name: 'keywords',
      content: 'AI旅游规划大师,旅游顾问,旅游规划咨询,AI聊天,路线问题,Chen,AI智能体'
    }
  ]
})
...
const sendMessage = (message) => {
  ...
  eventSource = chatWithTourismApp(message, chatId.value)
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到AI旅游规划大师，请告诉我你的旅游规划问题，我会尽力给予帮助和建议。', false)
})
