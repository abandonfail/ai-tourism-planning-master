  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">ChenAI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI旅游规划大师</div>
          <div class="app-desc">智能旅游顾问，帮你解答旅游烦恼</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: 'ChenAI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'ChenAI超级智能体应用平台提供AI旅游规划大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI旅游规划大师,AI助手,智能对话,Chen,AI超级智能体,首页'
    }
  ]
})
